        ...
        >
          ...
          <div className="flex items-center justify-between gap-2 px-5 py-5">
            <div className="relative h-8 w-28 shrink-0">
              <Image src="/lightmode.webp" alt="MenuQR Logo" fill sizes="112px" className="object-contain dark:hidden" />
              <Image src="/darkmode.webp" alt="MenuQR Logo" fill sizes="112px" className="object-contain hidden dark:block" />
            </div>
            ...
            <div>
              ...
              <div className="space-y-0.5">
                {menuNavItems.map((item) => {
                  ...
                  const isLocked = item.href === "/dashboard/reports" && planTier === "free";
                  return (
                    <Link
                      key={item.href}
                      href={item.href}
                      onClick={onClose}
                      className={cn(
                        "flex items-center justify-between rounded-xl px-3 py-2.5 text-sm font-semibold transition-all duration-150",
                        isActive
                    ...
                    >
                      ...
                      {isLocked && (
                        <span className="text-[10px] text-amber-500 bg-amber-50 dark:bg-amber-950/40 px-1.5 py-0.5 rounded flex items-center gap-0.5">
